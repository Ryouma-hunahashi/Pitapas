...
{
	{"asset/BGM/174_BPM164.wav", true},	// サンプルBGM（ループさせるのでtrue設定）
	{"asset/BGM/Stage1_BGM.wav",true},
	{"asset/BGM/Stage2_BGM.wav",true},
	{"asset/BGM/Stage3_BGM.wav",true},
	{"asset/BGM/Stage4_BGM.wav",true},
	{"asset/BGM/Title_BGM.wav",true},
	{"asset/SE/Cursor.wav",false},
	{"asset/SE/clickbutton.wav",false},
};
...
// 初期化
//=============================================================================
HRESULT CSoundManager::XA_Initialize()
{
	HRESULT      hr;
...
// 開放処理
//=============================================================================
void CSoundManager::XA_Release(void)
{
	for (int i = 0; i < SOUND_LABEL_MAX; i++)
	{
		if (g_pSourceVoice[i])
...
// 再生
//=============================================================================
void CSoundManager::XA_Play(SOUND_LABEL label, float volume)
{
...
// 停止
//=============================================================================
void CSoundManager::XA_Stop(SOUND_LABEL label)
{
...
// 一時停止
//=============================================================================
void CSoundManager::XA_Resume(SOUND_LABEL label)
{
	IXAudio2SourceVoice*& pSV = g_pSourceVoice[(int)label];
	pSV->Start();
}
